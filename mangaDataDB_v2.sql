...
CREATE TABLE mangadatadb.cube (pk serial PRIMARY KEY NOT NULL, plate INTEGER, mangaid TEXT, designid INTEGER,
					pipeline_info_pk INTEGER, wavelength_pk INTEGER, cart_pk INTEGER, ifudesign_pk INTEGER,
					specres REAL[]);
...
CREATE TABLE mangadatadb.spaxel (pk serial PRIMARY KEY NOT NULL, flux REAL[], ivar REAL[], 
				mask INTEGER[], cube_pk INTEGER);

CREATE INDEX CONCURRENTLY spaxel_idx ON mangadatadb.spaxel using GIN(flux,ivar,mask);
				
CREATE TABLE mangadatadb.wavelength (pk serial PRIMARY KEY NOT NULL, wavelength REAL[],
				bintype TEXT);
...
CREATE TABLE mangadatadb.fibers (pk serial PRIMARY KEY NOT NULL, fiberid INTEGER, specfibid INTEGER, fnum INTEGER, 
	ring INTEGER, dist_mm REAL,xpmm REAL, ypmm REAL, fiber_type_pk INTEGER, target_type_pk INTEGER, ifudesign_pk INTEGER);
...
CREATE TABLE mangadatadb.sample (pk serial PRIMARY KEY NOT NULL, manga_tileid INTEGER, ifu_ra REAL, ifu_dec REAL,
	target_ra REAL, target_dec REAL, iauname TEXT, ifudesignsize INTEGER, ifutargetsize INTEGER, 
	ifudesignwrongsize INTEGER, field INTEGER, run INTEGER, nsa_redshift REAL, nsa_zdist REAL, 
	nsa_absmag_F REAL,nsa_absmag_N REAL,nsa_absmag_u REAL,nsa_absmag_g REAL,nsa_absmag_r REAL,nsa_absmag_i REAL,
	nsa_absmag_z REAL,nsa_mstar REAL, nsa_vdisp REAL, nsa_inclination REAL, nsa_petro_th50 REAL, 
	nsa_petroflux_F REAL,nsa_petroflux_N REAL,nsa_petroflux_u REAL,nsa_petroflux_g REAL,nsa_petroflux_r REAL,
	nsa_petroflux_i REAL,nsa_petroflux_z REAL,nsa_petroflux_ivar_F REAL,nsa_petroflux_ivar_N REAL,
	nsa_petroflux_ivar_u REAL,nsa_petroflux_ivar_g REAL,nsa_petroflux_ivar_r REAL,nsa_petroflux_ivar_i REAL,
	nsa_petroflux_ivar_z REAL,nsa_sersic_ba REAL, nsa_sersic_n REAL, nsa_sersic_phi REAL, 
	nsa_sersic_th50 REAL, nsa_sersicflux_F REAL,nsa_sersicflux_N REAL,nsa_sersicflux_u REAL,nsa_sersicflux_g REAL,
	nsa_sersicflux_r REAL,nsa_sersicflux_i REAL,nsa_sersicflux_z REAL,nsa_sersicflux_ivar_F REAL,
	nsa_sersicflux_ivar_N REAL,nsa_sersicflux_ivar_u REAL,nsa_sersicflux_ivar_g REAL,nsa_sersicflux_ivar_r REAL,
	nsa_sersicflux_ivar_i REAL,nsa_sersicflux_ivar_z REAL, cube_pk INTEGER);
...
CREATE TABLE mangadatadb.test_rssfiber (pk serial PRIMARY KEY NOT NULL, flux JSON, cube_pk INTEGER);
