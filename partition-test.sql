-- partitioning test
-- partiton cleanspaxelprop5 on range of pkeys.  2 partitions for now.

-- drop table suetest.cleanspaxelprop5_pt;



CREATE unlogged TABLE  suetest.cleanspaxelprop5_pt (
	pk int8 not null,
	file_pk int4 NULL,
