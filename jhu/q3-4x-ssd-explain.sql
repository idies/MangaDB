...
SELECT
  ...
  mangadapdb.c5_ssd.emline_sew_ha_6564                  AS emline_sew_ha_6564,
...
WHERE CAST(CASE WHEN (mangasampledb.nsa.sersic_mass > 0.0)
  ...
  THEN log(mangasampledb.nsa.sersic_mass)
      ...
      AND mangadapdb.c5_ssd.emline_sew_ha_6564 > 6.0 AND drpalias.pk = 25 AND dapalias.pk = 26;
...
SELECT
  ...
  concat(mangadatadb.cube.plate, '-', mangadatadb.ifudesign.name) AS "cube.plateifu",
  mangadatadb.ifudesign.name                                      AS "ifu.name",
  mangadapdb.c5_cx_ssd.emline_sew_ha_6564                  AS emline_sew_ha_6564,
  mangasampledb.nsa.sersic_n                                      AS "nsa.sersic_n",
  CAST(CASE WHEN (mangasampledb.nsa.sersic_mass > 0.0)
    THEN log(mangasampledb.nsa.sersic_mass)
       WHEN (mangasampledb.nsa.sersic_mass = 0.0)
...
WHERE CAST(CASE WHEN (mangasampledb.nsa.sersic_mass > 0.0)
  ...
  THEN log(mangasampledb.nsa.sersic_mass)
                                                    WHEN (mangasampledb.nsa.sersic_mass = 0.0)
                                                      THEN 0.0 END AS FLOAT) < 11.0 AND mangasampledb.nsa.sersic_n < 2.0
      AND mangadapdb.c5_cx_ssd.emline_sew_ha_6564 > 6.0 AND drpalias.pk = 25 AND dapalias.pk = 26;
 ...
 SELECT
   ...
   concat(mangadatadb.cube.plate, '-', mangadatadb.ifudesign.name) AS "cube.plateifu",
   mangadatadb.ifudesign.name                                      AS "ifu.name",
   mangadapdb.c5_cstore_ssd.emline_sew_ha_6564                  AS emline_sew_ha_6564,
   mangasampledb.nsa.sersic_n                                      AS "nsa.sersic_n",
   CAST(CASE WHEN (mangasampledb.nsa.sersic_mass > 0.0)
     THEN log(mangasampledb.nsa.sersic_mass)
        WHEN (mangasampledb.nsa.sersic_mass = 0.0)
 ...
 WHERE CAST(CASE WHEN (mangasampledb.nsa.sersic_mass > 0.0)
   ...
   THEN log(mangasampledb.nsa.sersic_mass)
                                                     WHEN (mangasampledb.nsa.sersic_mass = 0.0)
                                                       THEN 0.0 END AS FLOAT) < 11.0 AND mangasampledb.nsa.sersic_n < 2.0
      AND mangadapdb.c5_cstore_ssd.emline_sew_ha_6564 > 6.0 AND drpalias.pk = 25 AND dapalias.pk = 26;
