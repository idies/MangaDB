...
--create table mangadapdb.c5_ssd as select * from mangadapdb.cleanspaxelprop5

CREATE	INDEX CX_c5_ssd_file_pk on mangadapdb.c5_ssd ( file_pk ) WITH (FILLFACTOR=100);
--alter table mangadapdb.c5_ssd cluster on cx_file_pk;
