...
-- DROP TABLE mangadapdb.cleanspaxelprop5;

CREATE TABLE mangadapdb.cleanspaxelprop5 (
	pk int8 NULL,
	file_pk int4 NULL,
...
CREATE INDEX clean_binid5_pk_idx ON mangadapdb.cleanspaxelprop5 USING btree (binid);
CREATE INDEX clean_d40005_idx ON mangadapdb.cleanspaxelprop5 USING btree (specindex_d4000);
CREATE INDEX clean_emline5_gflux_ha_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_ha_6564);
CREATE INDEX clean_emline5_gflux_hb_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_hb_4862);
CREATE INDEX clean_emline5_gflux_ivar_ha_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_ivar_ha_6564);
CREATE INDEX clean_emline5_gflux_ivar_hb_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_ivar_hb_4862);
CREATE INDEX clean_emline5_gflux_ivar_nii_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_ivar_nii_6585);
CREATE INDEX clean_emline5_gflux_ivar_oi_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_ivar_oi_6302);
CREATE INDEX clean_emline5_gflux_ivar_oiid_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_ivar_oiid_3728);
CREATE INDEX clean_emline5_gflux_ivar_oiii_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_ivar_oiii_5008);
CREATE INDEX clean_emline5_gflux_ivar_sii_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_ivar_sii_6718);
CREATE INDEX clean_emline5_gflux_ivar_siia_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_ivar_sii_6732);
CREATE INDEX clean_emline5_gflux_nii_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_nii_6585);
CREATE INDEX clean_emline5_gflux_oi_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_oi_6302);
CREATE INDEX clean_emline5_gflux_oii_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_oiid_3728);
CREATE INDEX clean_emline5_gflux_oiii_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_oiii_5008);
CREATE INDEX clean_emline5_gflux_sii_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_sii_6718);
CREATE INDEX clean_emline5_gflux_siia_idx ON mangadapdb.cleanspaxelprop5 USING btree (emline_gflux_sii_6732);
CREATE INDEX clean_file5_pk_idx ON mangadapdb.cleanspaxelprop5 USING btree (file_pk);
CREATE INDEX clean_spaxel5_index_idx ON mangadapdb.cleanspaxelprop5 USING btree (spaxel_index);
CREATE INDEX clean_stvel5_idx ON mangadapdb.cleanspaxelprop5 USING btree (stellar_vel);
