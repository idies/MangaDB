...
CREATE INDEX wavelength_pk_idx ON suetest.cube1 USING btree (wavelength_pk);
CREATE INDEX cube1_shape_pk_idx ON suetest.cube1 USING btree (cube1_shape_pk);
CREATE INDEX ifudesign_pk_idx ON suetest.cube1 USING btree (ifudesign_pk);
CREATE INDEX manga_target1_pk_idx ON suetest.cube1 USING btree (manga_target_pk);
CREATE INDEX pipelineinfo_pk_idx ON suetest.cube1 USING btree (pipeline_info_pk);
...
CREATE INDEX wavelength_pk_idx ON suetest.cube USING btree (wavelength_pk)
CREATE INDEX cube_shape_pk_idx ON suetest.cube USING btree (cube_shape_pk)
CREATE INDEX ifudesign_pk_idx ON suetest.cube USING btree (ifudesign_pk)
CREATE INDEX manga_target_pk_idx ON suetest.cube USING btree (manga_target_pk)
CREATE INDEX pipelineinfo_pk_idx ON suetest.cube USING btree (pipeline_info_pk)
CREATE INDEX cube_q3c_ang2ipix_idx ON suetest.cube USING btree (q3c_ang2ipix(ra, "dec"))
...
CREATE INDEX nsa_elpetro_ba_idx ON suetest.nsa USING btree (elpetro_ba)
CREATE INDEX nsa_elpetro_mass_idx ON suetest.nsa USING btree (elpetro_mass)
CREATE INDEX nsa_elpetro_phi_idx ON suetest.nsa USING btree (elpetro_phi)
CREATE INDEX nsa_elpetro_th50r_idx ON suetest.nsa USING btree (elpetro_th50_r)
CREATE INDEX nsa_elpetro_th90r_idx ON suetest.nsa USING btree (elpetro_th90_r)
CREATE INDEX nsa_sersic_mass_idx ON suetest.nsa USING btree (sersic_mass)
CREATE INDEX nsa_sersic_n_idx ON suetest.nsa USING btree (sersic_n)
CREATE INDEX nsa_z_idx ON suetest.nsa USING btree (z)
