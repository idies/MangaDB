...
FROM (SELECT
        ...
        mangadapdb.cleanspaxelprop5.emline_gflux_ha_6564                AS "spaxelprop.emline_gflux_ha_6564",
      ...
      WHERE drpalias.pk = 21 AND dapalias.pk = 23 AND goodhacount.valcount >= 0.2 * bingood.goodcount) AS anon_1
