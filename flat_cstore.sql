CREATE foreign TABLE mangadapdb.flat_cstore (
	drppipe int4 NULL,
	dappipe int4 NULL,
	plate int4 NULL,
	mangaid text NULL,
	...
	y int4 NULL
     ...
     options(filename '/xfs/postgres_db/cstore/flat_cstore.cstore', compression 'pglz');
     
     
     insert into mangadapdb.flat_cstore
     select * from mangadapdb.flattabletest;
     
    
     analyze mangadapdb.flat_cstore;
